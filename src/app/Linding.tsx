...
import { CheckCircle, Zap, Users, Heart, ArrowRight, Menu, X } from 'lucide-react'
      ...
      <section className="relative min-h-screen flex items-center justify-center pt-20">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          <p className="text-xl md:text-2xl mb-8 text-slate-300 max-w-3xl mx-auto">
            Harness the power of AI to generate professional UML diagrams from simple text descriptions. 
            Design faster, collaborate better, and bring your ideas to life.
          </p>
          ...
          <Card className="inline-block bg-slate-900/50 border-slate-700 backdrop-blur-sm">
            <CardContent className="p-4">
              <img 
                src="https://placehold.co/800x500/3b82f6/ffffff?text=DiagramAI+Platform" 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-slate-400 max-w-2xl mx-auto">
              Everything you need to create, share, and collaborate on UML diagrams
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="bg-slate-900 border-slate-700 hover:border-blue-500/50 transition-all duration-300 hover:transform hover:scale-105">
              <CardHeader>
                ...
                <CardDescription className="text-slate-400">
                  Transform natural language descriptions into professional UML diagrams instantly using advanced AI technology.
                </CardDescription>
              </CardHeader>
              <CardContent>
                <img 
                  src="https://placehold.co/600x400/3b82f6/ffffff?text=AI+Generation" 
            ...
            <Card className="bg-slate-900 border-slate-700 hover:border-blue-500/50 transition-all duration-300 hover:transform hover:scale-105">
              <CardHeader>
                ...
                <CardDescription className="text-slate-400">
                  Clean, user-friendly interface that makes diagram creation accessible to everyone, from beginners to experts.
                </CardDescription>
              </CardHeader>
              <CardContent>
                <img 
                  src="https://placehold.co/600x400/06b6d4/ffffff?text=User+Interface" 
                  alt="User Interface" 
                  className="rounded-lg w-full"
                />
              </CardContent>
            ...
            <Card className="bg-slate-900 border-slate-700 hover:border-blue-500/50 transition-all duration-300 hover:transform hover:scale-105">
              <CardHeader>
                ...
                <CardDescription className="text-slate-400">
                  Share diagrams, collaborate with others, and learn from a vibrant community of designers and developers.
                </CardDescription>
              </CardHeader>
              <CardContent>
                <img 
                  src="https://placehold.co/600x400/0ea5e9/ffffff?text=Community+Hub" 
                  alt="Community Hub" 
                  className="rounded-lg w-full"
                />
              </CardContent>
            ...
            {[
              {
                ...
                description: "Simply type what you want to create in natural language. Our AI understands your requirements.",
                image: "https://placehold.co/600x400/3b82f6/ffffff?text=Step+1%3A+Text+Input"
              },
              {
                step: "2", 
                title: "AI Generates Diagram",
                description: "Our advanced AI processes your description and generates a professional UML diagram using PlantUML.",
                image: "https://placehold.co/600x400/0ea5e9/ffffff?text=Step+2%3A+AI+Processing"
              },
              {
                step: "3",
                title: "Share & Collaborate", 
                description: "Export, share, and collaborate on your diagrams with team members and the community.",
                image: "https://placehold.co/600x400/06b6d4/ffffff?text=Step+3%3A+Share+%26+Export"
              }
            ].map((item, index) => (
              <div key={index} className="text-center">
                ...
                <Card className="bg-slate-900/50 border-slate-700">
                  <CardContent className="p-4">
                    <img src={item.image} alt={`${item.title} Step`} className="rounded-lg w-full" />
                  </CardContent>
                </Card>
              </div>
            ))}
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-slate-400 mb-6 text-lg">
                Publish your diagrams to our community gallery, get feedback from peers, and inspire others with your designs. 
                Build your reputation and showcase your modeling skills.
              </p>
            ...
            <Card className="bg-slate-900/50 border-slate-700">
              <CardContent className="p-4">
                <img 
                  src="https://placehold.co/600x400/2563eb/ffffff?text=Community+Gallery" 
      ...
      <section className="py-20 bg-gradient-to-br from-blue-900/20 via-slate-950 to-cyan-900/20 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <p className="text-xl md:text-2xl mb-8 text-slate-300">
            Join thousands of developers and designers creating better diagrams with AI
          </p>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-slate-400">
                Transform your ideas into beautiful UML diagrams using the power of artificial intelligence.
              </p>
            </div>
